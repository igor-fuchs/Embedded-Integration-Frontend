...
export default function BigConveyor({ id, ref, running, bodyIndex, bodyStyle, beltStyle, scaleFactor }: BigConveyorProps) {
    ...
    return (
        <StyleBigConveyor id={id} ref={ref} style={bodyStyle} $animationDurationMs={animationDurationMs} $running={running} >
            ...
            {/* Belt Animated */}
            <div className={classNameBelt} style={{ ...beltStyle, zIndex: beltIndex }}>
